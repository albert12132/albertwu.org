...
------------
 ...
 I had been maintaining two different templating engines.
The first was for
[generating my website](https://github.com/albert12132/albertwu.org),
and had evolved between Spring 2013 and Spring 2014. The second was for
publishing labs for UC Berkeley's introductory computer science course,
[CS 61A](inst.eecs.berkeley.edu/~cs61a) (first used for the Spring 2014
semester). I designed the two templaters with similar features, though
there were minor differences that fit each use case.



In an attempt to unify the two projects (and to make maintenance
easier), I created Templar, a static templating engine written in
Python.

that is designed to be lightweight and flexible.  Templar
supports template inheritance and modular source files, as well as the
ability to define custom Markdown patterns.
