...
code_questions = [
    {'description': """Implement the function <tt>filter</tt>, which takes a predicate and a Scheme list as arguments. <tt>filter</tt> will return a new list that only contains elements of the original list that satisfy the predicate.""",
     'code': """
...
(define (filter pred lst)
    ...
    {'description': """Implement the function <tt>interleave</tt>, which takes a two lists as arguments. <tt>interleave</tt> will return a new list that interleaves the elements of the two lists, with <tt>list1</tt> starting first. Refer to the tests for sample input/output.""",
     'code': """
...
(define (interleave list1 ist2)
    ...
    {'description': """Implement the function <tt>count-stairways</tt>, which takes a number (of steps). Assuming we can take 1 or 2 steps, return the number of ways we can climb up the stairs.""",
     'code': """
